...
public class VMWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VMWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new VMWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VMWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VMWDateTimeConverter dateTimeConverter = new VMWStandardDateTimeConverter();

    public VMWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VMWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VMWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VMWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public SoapObject GetSoapObject(Element detailElement) {
        ...
        catch (java.lang.Exception e)
        {
			if(enableLogging)
			{
				android.util.Log.e(VMWExtendedSoapSerializationEnvelope.TAG,"Error occured",e);
			}
        }
        return null;
    }
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VMWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VMWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
