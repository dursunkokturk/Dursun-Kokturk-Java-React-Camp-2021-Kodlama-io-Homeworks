...
public class VMWKPSPublicSoap
{
    ...
    public VMWKPSPublicSoap(){}

    public VMWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VMWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VMWExtendedSoapSerializationEnvelope envelope= new VMWExtendedSoapSerializationEnvelope(VMWExtendedSoapSerializationEnvelope.VER11);
